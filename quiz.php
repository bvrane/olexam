...
<style>
body{
	background-image:url("background-wallpapers.jpg");
...
{	
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				echo "</table>";
				mysqli_query($cn,"insert into mst_result(login,test_id,score) values('$login',$tid,$_SESSION[trueans])") or die(mysqli_error());
